...
定时任务的规则、提示词各版本、工作流和已生成报告都在本仓库。另一个 Cursor 账号打开仓库后，按 [`prompts/CONTINUITY.md`](prompts/CONTINUITY.md) 重建日程为 `30 0 * * 1-5`（北京时间工作日 08:30）、模型为 GPT、并接上同花顺 iFinD 的自动任务，即可延续。
